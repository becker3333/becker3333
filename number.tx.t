...
5223 many reasons, ranging from making your living to solving
513 a difficult data analysis problem to having fun to helping
...
as 3752 our 2673 personal 8750 assistants who can take care of many things
...
1290 us do many different things.
...
to 9615 your 6352 partner 438 (the computer), leaving more time 
 for you to do the 
...
85 Central Processing Unit (or CPU) is 
...
learn 2758 how 6509 to 6060 talk fast to keep up with the CPU.
 
Main Memory is used to store information
2230 that the CPU needs in a hurry.  The main memory is nearly as 127
...
These 3168 days, 8688 most 13 computers also have a
 Network Connection to retrieve information over a network.
9931 We can think of the network as a very slow place to store and 2731
...
4686 find it much easier to learn a second programming language such
...
1115 write a program that solves that problem.  And once you get 7955
3455 to that point, programming becomes a very pleasant and creative process.  
...
1286 Unlike human languages, the Python vocabulary is actually pretty small. 4724
3134 We call this vocabulary the reserved words.  These are words that
...
3963 by a string of text of our choosing enclosed in single quotes. 8280

Conversing with Python

Now that we have a word and a simple sentence that we know in Python,
we 5353 need 9450 to 2298 know how to start a conversation with Python to test 
 7961 our new language skills. 2451
...
3453 is amazingly complex and powerful and very picky about 
...
3299 is represented all in zeros and ones. 7375
...
7958 Some of the lines of Python tell Python that you want it to remember some 
value 6530 for 2002 later. 6783   We need to pick a name for that value to be remembered and
 we can use that symbolic name to retrieve the value later.  We use the 
term 1180 variable 7108 to 1389 refer to the labels we use to refer to this stored data.
...
7937 is treating them as an ordered sequence of statements with later statements able 7877
...
1692 and then the compiler puts the resulting machine language into a file for later
execution.
...
3000 You can look at the actual source code for the Python interpreter by
...
9827 convention, Python scripts have names that end with .py.
...
3602 You will notice that there was no need to have quit() at the end of
